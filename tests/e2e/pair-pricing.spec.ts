...
test.describe('Pair Pages Pricing', () => {
  ...
  test('should handle checkout with default pricing', async ({ page }) => {
    ...
    await page.click('button:has-text("Buy Single Kit")')
  ...
  test('should display correct country names in title and content', async ({ page }) => {
    await page.goto('/kits/marriage-kit/FR-JP')
    
    // Should show correct country names
    await expect(page.locator('text=Marriage Kit: France & Japan')).toBeVisible()
