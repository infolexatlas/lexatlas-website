...
test.describe('Pricing Page', () => {
  test('should display pricing page with working FAQ accordion', async ({
    page,
  }) => {
  ...
  test('should have working FAQ accordion on pricing page', async ({
    page,
  }) => {
    await page.goto('/pricing')
  ...
  test('should have pricing cards with Most Popular badge', async ({
    page,
  }) => {
    await page.goto('/pricing')
    ...
    await expect(
      page.getByRole('heading', { name: 'Single Kit' })
    ).toBeVisible()
    await expect(
      page.getByRole('heading', { name: 'Bundle of 3' })
    ).toBeVisible()
