...
// Align with Next.js generated PageProps which may be Promise-like
interface PageParams { slug: string }

export async function generateMetadata({ params }: { params: PageParams } | any): Promise<Metadata> {
  const { slug } = params
...
export default function PreviewPage({ params }: { params: PageParams } | any) {
  const { slug } = params
