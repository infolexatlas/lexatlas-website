...
export async function POST(request: NextRequest) {
  try {
    ...
    if (isFakeCheckout) {
      ...
      url.searchParams.set('kind', 'bundle10');
      ...
      line_items: [
        {
          price_data: {
            currency: 'eur',
            product_data: {
              name: 'Full Pack - 10 Marriage Kits',
              description: 'Complete collection of all marriage kits - Best value at €20/kit',
            },
            unit_amount: STRIPE_CATALOG.bundle_10.amount, // €200.00 in cents
          },
          quantity: 1,
        },
      ],
    ...
    console.error('[checkout/bundle10] error:', error)
